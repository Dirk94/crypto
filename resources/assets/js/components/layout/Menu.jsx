            ...
            <nav className="sidebar-nav">
                <div className="sidebar-header">
                    ...
                    <Link className="sidebar-brand img-responsive" to='/'>
                        ...
                        <span className="sidebar-brand-text">CryptoTracker</span>
                    </Link>
                </div>
                ...
                <div className="collapse nav-toggleable-md" id="nav-toggleable-md">
                    <ul className="nav nav-pills nav-stacked flex-column">
                        ...
                        <li className="nav-item">
                            <NavLink activeClassName="active" className="nav-link" to='/trades'>Your Trades</NavLink>
                        </li>

                        <li className="nav-header">Settings</li>
                        <li className="nav-item">
                            <NavLink activeClassName="active" className="nav-link" to='/settings'>Account Settings</NavLink>
                        </li>
                        <li className="nav-item">
